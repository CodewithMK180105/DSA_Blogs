        ...
        <div className="flex items-center justify-center min-h-screen ">
            <div className="bg-white p-10 rounded-xl shadow-2xl max-w-lg w-full">
                ...
                <form className="space-y-6">
                    ...
                    <Button 
                        type="submit" 
                        className="w-full flex justify-center py-6 px-6 border border-transparent rounded-lg shadow-lg text-lg font-semibold text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
                    >
                        Login
                    </Button>
                </form>
